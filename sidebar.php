    <div id="middlebar">
      <ul id="catnav">
        <li<?php if (is_home()) { echo " class=\"active\"";}?>><a href="<?php echo get_settings('home'); ?>">The Front Page</a><a href="<?php echo get_settings('home'); ?>"><a href="<?php bloginfo('rss2_url'); ?>"><img style="margin-top: -25px;" src="http://looce.com/wordpress/wp-content/themes/wakingideas/images/feedicon.png" alt="Subscribe to RSS" /></a></a></li>
